...
function EHM_HonorVendor:BuildPopup()
    ...
    for i = 1, GetMerchantNumItems() do
        ...
        if itemID and itemData and merchantId == itemData.merchant.index then
            ...
            btn.priceText:SetTextColor(canAfford and 1 or 0.5, canAfford and 1 or 0.5, canAfford and 1 or 0.5)
...
EHM.CreateActionButtons(
    EHM_HonorVendor,
    {
        ...
        { name = "Auto",  command = function() SlashCmdList[EHM.COMMANDS.AUTO.key]("") end },
        { name = "Statistic" },
    },
    15,
    -39,
